...
<main>
                    <div class="container-fluid px-4 main">
                        ...
                        <h1 class="mt-4">edit main page</h1>
                        ...
                        <input  class="mt-3" type="file" name="hero_image" oninput="prevImage.src=window.URL.createObjectURL(this.files[0])">
                            ...
                            <div class="col-md-4">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="title2" id="title2" class="form-control" value="{{ $hero->title2 }}">
                                </div>
                                <div>
                                    <label for="sub_title">Sub Title</label>
                                    <input type="text" name="sub_title" id="sub_title" class="form-control" value="{{ $hero->sub_title }}">
                                </div>
                            </div>
                        </div>
